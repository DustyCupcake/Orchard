...
// §5.3): it now lives under /[cycleScope] and gates on the view-scope
// cycle when the community runs cycles, staying community-wide for
// cycle-less ones — the same movement /participation and /budget made
// (Phase 65). A cycle-less coordination task (column authority) or an
// empty "active" aggregate keeps today's community-wide gate; a
// cycle-placed coordinator is admitted for their own cycle row.
//
// The view's own content (Availability + engagement patterns) is
// unchanged — Availability isn't branch- or cycle-keyed data, so
// there's nothing to narrow it by; only who may reach the page is
// scope-aware.
